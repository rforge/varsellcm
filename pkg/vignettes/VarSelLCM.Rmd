...
res.noselec <- VarSelCluster(x, 2, crit.varsel = "ICL", vbleSelec = FALSE, nbcores = nb.CPU)
# clustering with variable selection
res.selec <- VarSelCluster(x, 1:3, crit.varsel = "MICL", vbleSelec = TRUE, nbcores = nb.CPU)
```
...
ARI(res.noselec@partitions@zMAP, partition)
ARI(res.selec@partitions@zMAP, partition)
```
