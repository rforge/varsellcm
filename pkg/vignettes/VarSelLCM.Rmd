...
```{r, comment=""}
library(VarSelLCM)
# please install the package spikeslab to get the data
...
res.noselec <- VarSelCluster(leukemia[,-1], 2, crit.varsel = "ICL", vbleSelec = FALSE, nbcores = nb.CPU)
# clustering with variable selection
res.selec <- VarSelCluster(leukemia[,-1], 2, crit.varsel = "MICL", vbleSelec = TRUE, nbcores = nb.CPU)
```
...
ARI(res.noselec@partitions@zMAP, leukemia[,1])
ARI(res.selec@partitions@zMAP, leukemia[,1])
```
